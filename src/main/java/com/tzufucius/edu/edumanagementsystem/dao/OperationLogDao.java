...
public class OperationLogDao {
    ...
    private OperationLogVO operationLogVO(ResultSet rs, int rowNum) throws SQLException {
        return new OperationLogVO(
                rs.getLong("id"),
                nullableLong(rs, "userId"),
                rs.getString("username"),
                rs.getString("moduleName"),
                rs.getString("operationType"),
                rs.getString("targetTable"),
                nullableLong(rs, "targetId"),
                rs.getString("description"),
                rs.getString("ipAddress"),
                localDateTime(rs.getTimestamp("createdAt"))
        );
    }
